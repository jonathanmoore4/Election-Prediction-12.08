"""XGBoost with all pre-election predictors from the feature-engineering notebook."""
...
def train_xgboost_expanded(data: pd.DataFrame) -> Pipeline:
...
class XGBoostExpandedModel(custom_model):
    ...
    def train(self, data: pd.DataFrame) -> None:
        ...
        self.pipeline = train_xgboost_expanded(data)
