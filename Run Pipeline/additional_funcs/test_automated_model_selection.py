...
class ChangedSeatAccuracyTests(unittest.TestCase):
    def run_selection(self, previous_winners, expected_model=0, predictions=None):
        ...
        self.assertEqual(scores["evaluation_rows"].tolist(), [3] * 4)
        return best, scores
    ...
    def test_changed_subset_scores_and_combined_selection(self):
        ...
        self.assertEqual(scores["changed_seat_accuracy"].tolist(), [0, 1, 0, 0])
        self.assertEqual(scores["changed_seat_evaluation_rows"].tolist(), [1] * 4)
