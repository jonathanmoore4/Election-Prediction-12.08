...
SELECT
    ...
    polling_features.previous_con_share + polling_features.con_polling - national_shares.previous_nat_con_share AS projected_con_share,
    polling_features.previous_lib_share + polling_features.lib_polling - national_shares.previous_nat_lib_share AS projected_lib_share,
    polling_features.previous_lab_share + polling_features.lab_polling - national_shares.previous_nat_lab_share AS projected_lab_share
