...
def main():
    ...
    focus_years = [year for year in [1997,2010,2024] if year in set(detail.evaluation_year)]
    ...
    sections=['# All-election numerical results, 1997–2024\n',
        'Generated by `summarize_all_elections.py`. All architecture comparisons below use ten-seed ensembles and patience 20. See [the main report](../REPORT.md) for interpretation.\n',
        '## Temporal coverage\n',
